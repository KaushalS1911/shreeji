        ...
        <Container sx={{ zIndex: 2 }}>
          <Box >
            ...
            <Typography sx={{ mb: 1, ml: { lg: 15, md: 20, sm: 28 }, fontSize: '14px', fontWeight: 500 }}>
              <Typography variant="span" onClick={() => navigate('/')} sx={{ cursor: 'pointer' }} >Home</Typography> / <Typography variant="span" onClick={() => navigate('/our-products')} sx={{ cursor: 'pointer' }}>Our Products</Typography> / <Typography variant='span' sx={{ color: '#19AED7', fontWeight: 500 }}>Fresh Fruits & Vegetables</Typography>
            </Typography>
          </Box>
        </Container>
      </Box>
